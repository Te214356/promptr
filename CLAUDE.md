...
**سيو:** ~~9. `ج4` slug مدونة يردّ 200~~ ✅ **مُغلق 2026-09-12** (404 مقيس على الحيّ) · ~~`ج5` التصنيفات خارج `sitemap.xml`~~ ✅ **مُغلق 2026-09-12** (40 رابطًا مقيسة على الحيّ) · 9. `ج6` `next-sitemap.js` ملف ميّت · 11. **صفحة 404 عارية** لا تشبه الموقع
...
**محتوى وتسويق:** 13. `هـ1` AdSense (معلومات الدفع · صفر وحدة إعلانية) · `هـ2` مقالات جديدة · 14. **`هـ3` رفع شعار Promptr في لوحة ميسر** — لم يُتطرَّق له بعد
