...
| سلة أم زد؟ كيف تختار منصة متجرك الإلكتروني في السعودية | `salla-vs-zid-comparison.md` | ✍️ قيد الكتابة — المسودة جاهزة |

المقال الثاني مستخرج من القسم 2 في `products/ecommerce-success-guide/data.json`. قبل إنشاء الملف يحتاج ثلاثة تعديلات على المسودة:
1. إكمال السؤال الرابع في شجرة القرار
2. إعادة بناء جدول القنوات بأعمدة متسقة
3. التحقق من صحة رابط دليل المتجر الإلكتروني (`/products/ecommerce-success-guide`)
...
**الهدف:** 15–20 مقالًا أصليًا منشورًا — وهو ما يحتاجه تقديم AdSense (البند 3 أعلاه). المنشور اليوم: مقال واحد.
