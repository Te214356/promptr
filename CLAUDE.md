...
**سيو:** ~~9. `ج4` slug مدونة يردّ 200~~ ✅ **مُغلق 2026-09-12** (404 مقيس على الحيّ) · 9. `ج5` التصنيفات خارج `sitemap.xml` · 10. `ج6` `next-sitemap.js` ملف ميّت · 11. **صفحة 404 عارية** لا تشبه الموقع
