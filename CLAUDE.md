...
| البند | الدليل |
|---|---|
| **مسار الشراء من طرف إلى طرف على الإنتاج** | شراء بشري حقيقي بمفاتيح حيّة: الدفع ⟵ الحارسان ⟵ الطلب 25 ⟵ البريد ⟵ رابط التحميل. ثلاثة مصادر متطابقة وجدول زمني — قسم «الشرط [أ] مُغلق نهائيًا» |
| **حارسا الدفع** (الربط والاستهلاك) | مقيسان على شراء حقيقي لا على تجربة: ميسر أعاد `metadata.cart_id`، والفهرس الفريد قَبِل مطالبة واحدة |
| **البريد ورابط التحميل** | خرج من `orders@promptrsa.com` وفتح الملف |
| **أرضية تباين WCAG AA** | مسح حيّ بمحرك سفاري: **352 قياسًا · 16 راسبًا كلها زر واتساب** (مستثنى بقرار المالك) |
| **شعارات الدفع** | الأربعة رسمية من مصادرها، بلا تخفيف، ونسبها محفوظة |
| **كود الخصم الاختباري** | `TEST-JSB4…` ⟵ `inactive` بعد `used: 1/1` |
| **خلفية `#080810`** | قُيست ثلاثة بدائل: **صفر صف يُحل** بتغييرها. بقيت بقرار — لا تُعِد الاقتراح بلا سبب جديد |
...
### 🎯 الأولوية القادمة — **ليست تقنية**

**المتجر جاهز ولم يبع لعميل حقيقي بعد.** كل ما سبق أزال الأعذار التقنية: الدفع يعمل، والحارسان يحرسان، والتسليم يصل، والنصوص تُقرأ، وشارات الثقة حقيقية.

> ⛔ **فلا تبدأ الجلسة القادمة ببند تقني** إلا إن طلبه المالك صراحةً. البند الوحيد المستحق هو **جلب أول زوار حقيقيين** — وهو تسويق ومحتوى وقنوات، لا كود.
>
> وما يذكّر بحجم الفجوة: 17 مقالًا منشورًا و**5 نقرات من بحث Google في 28 يومًا**، وثلاث محاولات شراء فاشلة في 28 أغسطس هي أقرب ما وصل المتجر إلى عملاء حقيقيين. الأدوات للعمل موجودة في `.claude/agents/` (بحث · كتابة · يوتيوب · استشارة).
