...
5. `ب3` هل كانت آلية استرجاع السلة مطلوبة؟ · 6. `ب4` صفّا جدول `SameSite` غير المختبَرين
   > 💡 **الاثنان صارا قابلين للحسم** بأداة WebKit المبنية في هذه الجلسة (`playwright-core`) — كانا معلّقين لغياب متصفح آلي.
