...
## 📌 نقطة الاستئناف — 2026-09-13 (اقرأها أولًا)

> # 🎯 الأولوية القادمة **ليست تقنية**: جلب أول زوار حقيقيين.
>
> **لم يبقَ بند تقني يمنع بيعًا أو يضرّ مشتريًا.** الدفع يعمل، والحارسان يحرسان، والتسليم يصل، والنصوص تُقرأ، وشارات الثقة حقيقية، والسيو نظيف، واسم المتجر يظهر للمشتري صحيحًا. فلا تبدأ الجلسة القادمة ببند تقني إلا إن طلبه المالك صراحةً.
>
...
| **خلفية `#080810`** | ثلاثة بدائل قيست: **صفر مكسب**. بقيت بقرار |
...
**واجهة:** 7. صفحة 404 عارية · 8. `د8` الجزيرتان الفاتحتان · `د9` واتساب (مستثنى) · `د6` `app/error.tsx` الجذري · `د7` اليتيمان · `د10` `sku`
