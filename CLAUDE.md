...
>
> كتلة الوضع الداكن تقلب **الأسطح** أيضًا: `--bg-field` من `#FAFAFA` إلى `rgba(255,255,255,.04)`. وسطر `input, select, textarea { color:#000 !important }` يفرض نصًّا أسود على الحقول. فالمحدِّد وحده يجعل الحقل داكنًا والنص أسود عليه ⟵ **1.13:1، أي العطل نفسه منقولًا من النصوص إلى الحقول**.
>
