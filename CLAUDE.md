...
**5 مقالات منشورة من هدف 15–20** (انظر *الخطوة التالية* أدناه).

| المقال | الملف | المصدر | الحالة |
|---|---|---|---|
| كيف تكتب برومبت احترافي يعطيك نتيجة من أول محاولة | `how-to-write-effective-ai-prompts.md` | — | ✅ منشور |
| سلة أم زد؟ كيف تختار منصة متجرك الإلكتروني في السعودية | `salla-vs-zid-comparison.md` | `ecommerce-success-guide` قسم 2 | ✅ منشور |
| الأنظمة السعودية التي يجب أن تعرفها قبل فتح متجرك | `saudi-ecommerce-regulations.md` | `ecommerce-success-guide` قسم 3 | ✅ منشور |
| كيف ترد على عميل غاضب | `how-to-handle-angry-customer.md` | `customer-service-prompts` قسم 2 | ✅ منشور |
| أدوات الذكاء الاصطناعي: متى تستخدم كل واحدة | `ai-tools-when-to-use-each.md` | `ai-basics-arabic` قسم 2 | ✅ منشور |

**تنويع الشكل مقصود** ويجب أن يستمر: خريطة جهات رسمية، وبنية سلوكية من أربع خطوات، وإطار اختيار بأسئلة — لا قالبًا واحدًا مكررًا. أدلة المنتجات الـ12 لا تزال تغطي بقية الهدف بلا بحث خارجي.
...
3. **ربط Google AdSense** — البند 2 أُنجز، لكن التقديم ما زال يحتاج **عددًا كافيًا من المقالات الأصلية المنشورة**؛ حاليًا 5 مقالات من هدف 15–20. موضع الإعلانات محجوز مسبقًا بتعليق في `apps/storefront/src/app/[countryCode]/(main)/blog/layout.tsx` — الإعلانات في `/blog` فقط، لا في صفحات المتجر أو الدفع.

---

## الخطوة التالية: بناء أرشيف المقالات

**الهدف:** 15–20 مقالًا أصليًا منشورًا — وهو ما يحتاجه تقديم AdSense (البند 3 أعلاه). المنشور اليوم: **5 مقالات** (الجدول في قسم *المدونة*).
