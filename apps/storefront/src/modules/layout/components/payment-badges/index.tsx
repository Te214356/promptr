...
const VisaBadge = () => (
  <div className="flex items-center px-3 py-1.5 rounded-lg bg-white/5 border border-white/8">
    ...
    <div className={`flex flex-wrap items-center gap-2 ${compact ? "" : "gap-2.5"}`}>
      ...
      {!compact && (
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 border border-white/8">
          ...
          <span className="text-[#00CFFF]/70 text-[11px] font-medium">SSL Secured</span>
        </div>
      )}
    </div>
  )
