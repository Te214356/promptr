...
const OLD_BASE = "https://pub-8e6feaf55e8e2b16e30e47579b3213ac.r2.dev"
const NEW_BASE = "https://pub-896449c4f58a451cbf268d643d1dff28.r2.dev"
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  for (const product of products) {
    ...
    results.push(`${product.title}: updated`)
    updated++
  }
